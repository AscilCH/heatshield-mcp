...
async def chat_endpoint(req: ChatRequest):
    ...
    system_prompt = (
        ...
        "   - EVEN AFTER getting the schedule from the compute tools, you MUST STILL dynamically search for the official source document (using `search_web_for_pdfs` for OSHA, NIOSH, or CDC heat guidelines) to find specific engineering controls.\n"
